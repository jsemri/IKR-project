...
train_m = list(wav16khz2mfcc('target_train').values())
train_f = list(wav16khz2mfcc('non_target_train').values())
test_m  = list(wav16khz2mfcc('target_dev').values())
test_f  = list(wav16khz2mfcc('non_target_dev').values())
...
# Run 100 iterations of EM algorithm to train the two GMMs from males and females
for jj in range(100):
